...
COUPON_TYPES = app_settings.COUPON_TYPES
CODE_LENGTH = app_settings.CODE_LENGTH
CODE_CHARS = app_settings.CODE_CHARS
SEGMENTED_CODES = app_settings.SEGMENTED_CODES
SEGMENT_LENGTH = app_settings.SEGMENT_LENGTH
SEGMENT_SEPARATOR = app_settings.SEGMENT_SEPARATOR
...
class Coupon(models.Model):
    ...
    user = models.ForeignKey(user_model, verbose_name=_("User"), null=True, blank=True,
        help_text=_("You may specify a user you want to restrict this coupon to."), on_delete=models.CASCADE)
